    ...
    <section class="hero">
        <div class="wrapper wide-wrapper">
            <div class="hero-card">
                <img
                        class="hero-image"
                        src="<?= get_the_post_thumbnail_url(size: 'full') ?>"
                ...
                <article class="portfolio-item reveal-on-scroll ">
                    <div class="portfolio-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logos.webp"
                             alt="Branding & Logoentwicklung">
                    </div>

                    <div class="portfolio-content">
                        <h3>Branding & Logoentwicklung</h3>
                        <p>
                            Entwicklung und Gestaltung mehrerer Markenauftritte inklusive Logo-Design für verschiedene
                            Einsatzbereiche.
                            Ganzheitlicher Prozess von der Konzeptidee über Typografie und Farbwelt bis hin zur finalen
                            Umsetzung.
                            Ziel: klare Markenidentität und hoher Wiedererkennungswert.
                        </p>
                    </div>
                </article>
                   ...
                   rel="noopener noreferrer">
                    ...
                    <div class="portfolio-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/das_letzte_gewalzte_rohr.webp"
                             alt="Dokumentarfilm – Vallourec">
                    </div>

                    <div class="portfolio-content">
                        <h3>Dokumentarfilm – Vallourec</h3>
                        <p>
                            Verantwortlich für Schnitt und Postproduktion einer Dokumentation über die Werkschließung
                            der Vallourec-Werke.
                            Eigenständige Aufbereitung des Materials bis zur finalen Kinofassung.
                            Fokus auf emotionales Storytelling und authentische Bildsprache.
                        </p>
                    </div>
                </a>

                <a href="https://3promille.de"
                   class="portfolio-item reveal-on-scroll "
                   target="_blank"
                   rel="noopener noreferrer">
                    <div class="portfolio-image">
                    ...
                    <div class="portfolio-content">
                        ...
                        <p>
                            Ganzheitliche Umsetzung einer Event-Webseite inklusive Logo-Design, UI/UX-Konzept und
                            Entwicklung.
